...
export default function NewDeck(props) {
    ...
    let msg = <div data-bs-theme="dark">
        <link
            rel="stylesheet"
        ...
        />
        <Form action="/decks/new/submit" method="post">
                <Form.Group size="lg" className="title" controlId="formPlaintext">
                <Form.Label htmlFor="title">Title:</Form.Label>
                    <Form.Control type="text" id="name" aria-label="deck_name" />
                    <Form.Text id="name">ex. Topic 3</Form.Text>
                </Form.Group>
